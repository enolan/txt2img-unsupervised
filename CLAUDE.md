...
* Scripts
  ...
  * `txt2img_unsupervised/coordinate_check.py`. Check the muP implementations in the flow matching
    and transformer models are correct by visualizing the activation scale at different widths.
* Modules
